    ...
    return(
        <div className="h-lvh" style={{backgroundColor: '#edeff0'}}>
            <div className="h-full w-full m-auto shadow-md" style={{backgroundColor: '#f6f8fa' ,maxWidth: '1500px'}}>
                <div className="bg-white m-auto h-full shadow-md" style={{maxWidth: '900px'}}>
                ...
                <div className="bg-white dark:bg-gray-900">
                    <div className="py-8 lg:py-16 px-6">
                        <form action="#" className="space-y-8">
                            ...
                            {/* <div>
                                <div className="w-full">
                                    <label htmlFor="text" className="mb-2 text-sm font-inter text-gray-600 dark:text-gray-300">Guest 1 Name</label>
                                    <input 
                                        type="text" 
                                        id="text" 
                                        className="font-inter shadow-sm bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:shadow-sm-light focus:ring-gray-500 focus:border-gray-500 dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                                ...
                                <div className="flex flex-row items-center justify-between">
                                    <div className="w-5/12" style={{minWidth: '160px'}} >
                                        <label htmlFor="text" className="mb-2 text-sm font-inter text-gray-600 dark:text-gray-300">Guest 1 Contact Number</label>
                                    ...
                                    <div className="w-5/12" style={{minWidth: '160px'}}>
                                        <label htmlFor="email" className="mb-2 text-sm font-inter text-gray-600 dark:text-gray-300">Guest 1 Email ID</label>
                                        <input 
                                            type="email" 
                                            id="text" 
                                            className="font-inter shadow-sm bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:shadow-sm-light focus:ring-gray-500 focus:border-gray-500 dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                            ...
                            <div>
                                ...
                                <div className="w-full">
                                    <label htmlFor="text" className="mb-2 text-sm font-inter text-gray-600 dark:text-gray-300">Guest 2 Name</label>
                                    <input 
                                        type="text" 
                                        id="text" 
                                        className="font-inter shadow-sm bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:shadow-sm-light focus:ring-gray-500 focus:border-gray-500 dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                                ...
                                <div className="flex flex-row items-center justify-between">
                                    <div className="w-5/12" style={{minWidth: '160px'}} >
                                        <label htmlFor="text" className="mb-2 text-sm font-inter text-gray-600 dark:text-gray-300">Guest 2 Contact Number</label>
                                    ...
                                    <div className="w-5/12" style={{minWidth: '160px'}}>
                                        <label htmlFor="email" className="mb-2 text-sm font-inter text-gray-600 dark:text-gray-300">Guest 2 Email ID</label>
                                        <input 
                                            type="email" 
                                            id="text" 
                                            className="font-inter shadow-sm bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:shadow-sm-light focus:ring-gray-500 focus:border-gray-500 dark:focus:ring-primary-500 dark:focus:border-primary-500" 
